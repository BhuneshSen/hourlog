...
export class Backend implements backendInterface {
    ...
    async createNote(arg0: string, arg1: bigint, arg2: string): Promise<void> {
    ...
    async getNoteById(arg0: bigint): Promise<Note> {
        if (this.processError) {
            try {
    ...
    async getNotesByDate(arg0: string): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNotesByDate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
